...
- А ещё логарифмическую бурду делать
- И даже возводить в степень(Хотя зачем, если можно очень много умножать?)

Эксперементально: есть супер строка, куда можно писать магические письмена и получать ответы
Пример:

![Красота!](assets/example.png)
